...
| <a id="gen-ai-memory-record-id" href="#gen-ai-memory-record-id">`gen_ai.memory.record.id`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The unique identifier of a memory record. | `mem_5j66UpCpwteGg4YSxUnt7lPY` |
| <a id="gen-ai-memory-scope" href="#gen-ai-memory-scope">`gen_ai.memory.scope`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The scope of the memory store or memory operation. [6] | `user`; `conversation`; `agent` |
