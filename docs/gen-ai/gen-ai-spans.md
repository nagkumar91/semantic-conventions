...
| Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- |
| [`gen_ai.memory.scope`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The scope of the memory store or memory operation. [1] | `user`; `conversation`; `agent` |
...
| [`server.port`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If `server.address` is set. | int | GenAI server port. [6] | `80`; `8080`; `443` |
| [`server.address`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Recommended` | string | GenAI server address. [7] | `example.com`; `10.1.2.80`; `/tmp/my.sock` |
| [`gen_ai.memory.store.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | Human-readable name of the memory store. | `Customer Support Memory`; `Shopping Preferences` |
...
**[4] `error.type`:** The `error.type` SHOULD match the error code returned by the memory provider,
the canonical name of exception that occurred, or another low-cardinality error identifier.
Instrumentations SHOULD document the list of errors they report.
...
| `conversation` | Scoped to a conversation/thread. Context within a single conversation. | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`gen_ai.conversation.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` when searching conversation-scoped memory | string | The unique identifier for a conversation (session, thread), used to store and correlate messages within this conversation. | `conv_5j66UpCpwteGg4YSxUnt7lPY` |
...
| [`gen_ai.memory.type`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The type/tier of memory being operated on. [5] | `short_term`; `long_term` |
...
| [`gen_ai.memory.search.result.count`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int | Number of memory items returned from a search operation. | `3`; `10` |
| [`gen_ai.memory.store.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | Human-readable name of the memory store. | `Customer Support Memory`; `Shopping Preferences` |
...
| [`gen_ai.conversation.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` when operating on conversation-scoped memory | string | The unique identifier for a conversation (session, thread), used to store and correlate messages within this conversation. | `conv_5j66UpCpwteGg4YSxUnt7lPY` |
...
| [`gen_ai.memory.record.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` when available (provided or returned) | string | The unique identifier of a memory record. | `mem_5j66UpCpwteGg4YSxUnt7lPY` |
| [`gen_ai.memory.store.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` if applicable | string | The unique identifier of the memory store. | `ms_abc123`; `user-preferences-store` |
| [`server.port`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If `server.address` is set. | int | GenAI server port. [4] | `80`; `8080`; `443` |
...
| [`gen_ai.memory.type`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The type/tier of memory being operated on. [5] | `short_term`; `long_term` |
| [`server.address`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Recommended` | string | GenAI server address. [6] | `example.com`; `10.1.2.80`; `/tmp/my.sock` |
| [`gen_ai.memory.record.content`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | The content/value of the memory record. [7] | `{"preference": "dark_mode", "value": true}` |
| [`gen_ai.memory.store.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | Human-readable name of the memory store. | `Customer Support Memory`; `Shopping Preferences` |
...
**[7] `gen_ai.memory.record.content`:**
...
- If `gen_ai.memory.record.id` is not set, the request is to delete all memory records in the specified
  `gen_ai.memory.scope`.
...
| [`gen_ai.conversation.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` when deleting conversation-scoped memory | string | The unique identifier for a conversation (session, thread), used to store and correlate messages within this conversation. | `conv_5j66UpCpwteGg4YSxUnt7lPY` |
| [`gen_ai.memory.record.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` when deleting a specific memory record | string | The unique identifier of a memory record. | `mem_5j66UpCpwteGg4YSxUnt7lPY` |
| [`gen_ai.memory.store.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` if applicable | string | The unique identifier of the memory store. | `ms_abc123`; `user-preferences-store` |
